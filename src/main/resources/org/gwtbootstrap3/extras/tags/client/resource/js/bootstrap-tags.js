 ...
 * 
 * Note: This has been modified from the original version to include the options: iconBase and removeIcon, as they were hard-coded.
 */
...
(function($) {
    (function() {
        ...
        jQuery(function() {
            $.tags = function(element, options) {
                ...
                this.iconBase = || (this.iconBase = "remove");
                this.removeIcon || (this.removeIcon = "glyphicon glyphicon-remove-sign glyphicon-white" );
                ...
                this.formatTag = function(i, tag, isReadOnly) {
                    ...
                    return _this.template("tag", {
                        ...
                        iconBase: _this.iconBase,
                        removeIcon: _this.removeIcon,
    ...
    (function() {
        ...
        Tags.Templates["3"].tag = function(options) {
            ...
            return "<div class='tag label " + options.tagClass + " " + options.tagSize + "' " + (options.isPopover ? "rel='popover'" : "") + ">    <span>" + Tags.Helpers.addPadding(options.tag, 2, options.isReadOnly) + "</span>    " + (options.isReadOnly ? "" : "<a><i class='"+options.iconBase+" "+options.removeIcon+"' /></a>") + "  </div>";
        };
    }).call(this);
    (function() {
        var _base;
